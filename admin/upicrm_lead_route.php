...
<div id="content">
    <div class="row">
		...
		<span>
                    > 
                    <b><?php _e('Auto Lead Management','upicrm'); ?> </b>
                </span>
            </h1>
        </div>
    </div>
...
For example you can defined that If field "country" equals "India" , then assign this lead to the regional sales manager of India. 
            ...
            <form method="post" action="admin.php?page=upicrm_lead_route">
                ...
                <select name="field_id">
                    ...
                    foreach ($UpiCRMFields->get() as $field) { 
                        $selected = "";
                        if ($id > 0)
                            $selected = selected( $GetLeadsRouteOBJ->field_id, $field->field_id, false);
                        ?>
                ...
                <p class="submit"><input type="submit" name="submit" id="submit" class="button button-primary" value="<?php _e($id > 0 ? 'Update Lead Route' : 'Save Lead Route','upicrm'); ?>"></p>            </form>
        </div>
    </div>
                          ...
                          <table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($UpiCRMLeadsRoute->get() as $obj) { ?>
                                    <tr>
                                        <td data-belongs=""><?php echo $FieldsArr[$obj->field_id]; ?></td>
                                        <td data-belongs=""><?php echo $OperatorArr[$obj->lead_route_type]; ?></td>
                                        <td data-belongs=""><?php echo $obj->lead_route_value; ?></td>
...
<?php
        ...
        function saveRoute() {
            $UpiCRMLeadsRoute = new UpiCRMLeadsRoute();
            $insertArr['field_id'] = $_POST['field_id'];
        ...
        function updateRoute() {
            $UpiCRMLeadsRoute = new UpiCRMLeadsRoute();
            $updateArr['field_id'] = $_POST['field_id'];
